...
function App() {
    ...
    // fetch all todo task data from database using useEffect hook
    useEffect(() => {
    ...
    // delete a task from database, only delete when user clicks the delete button
    ...
    // before updating item, first show input field where we will create our updated item
